...
uint8_t Adafruit_TCS34725::read8(uint8_t reg)
{
    ...
    _wire->requestFrom(TCS34725_ADDRESS, 1);
#if ARDUINO >= 100
    return _wire->read();
#else
 ...
 */
/**************************************************************************/
Adafruit_TCS34725::Adafruit_TCS34725(TwoWire *wire, tcs34725IntegrationTime_t it, tcs34725Gain_t gain)
{
    _wire = wire;
